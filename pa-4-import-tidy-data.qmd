...
authors: "Ericka Quintero and Aiden Roach"
format: html
execute: 
  echo: true
  eval: false
...
youth1 <- read_csv("data-raw/YRBS2015.csv", 
                   skip = 1, 
                   na = c("N/A","."), 
                   col_types = list(`AgeCat` = col_number(), `Grade` = col_number(), `Perception of weight` = col_factor(levels = c("Very underweight","Slightly underweight", "About the right weight", "Slightly overweight", "Very overweight"))), 
                   `Gender` = col_character()) 
```

Describe some of the issues you notice in the data:

> Characters are combined with integers, plenty of missing information, and the variable names aren't very descriptive. 
